...
export default function App() {
  ...
  return (
    <div style={{ padding: "20px", backgroundColor: "#f0f2f5", minHeight: "100vh", fontFamily: "sans-serif", display: "flex", flexDirection: "column" }}>
      ...
      {/* NOVA TABELA DE APRESENTAÇÃO DOS PERFIS */}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(350px, 1fr))", gap: "20px", marginBottom: "40px" }}>
        ...
        {/* 1. Panorama Geral (ATUALIZADO: % e Índices) */}
          ...
          <ResponsiveContainer width="100%" height={260}>
            <PieChart>
              <Pie 
                ...
                outerRadius={70} 
                labelLine={true}
                label={({ value }) => `${value}%`} // Trava o % no gráfico
              >
      ...
      <div style={{ background: "#fff", padding: "20px", borderRadius: "10px", boxShadow: "0 4px 10px rgba(0,0,0,0.1)", flexGrow: 1 }}>
        <h3 style={{ color: "#1a3353", borderBottom: "2px solid #f0f2f5", paddingBottom: "10px", marginTop: 0 }}>
          📋 Tabela Detalhada (18 Métricas Científicas)
        </h3>
        <div style={{ overflowX: "auto" }}>
          <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left" }}>
            <thead>
